...
export const App = () => {
  ...
  const productSearchResults = !userSearchQuery
    ? []
  ...
  const categorySearchResults = Array.from(
    new Set(productSearchResults.map((product) => product.category))
  );
  ...
  const searchSuggestions = !userSearchQuery
    ? []
    : productSearchResults.length > 0
    ? [productSearchResults[0].name]
    : [];
